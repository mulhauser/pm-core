...
@Component({
  selector: 'app-modal-inviter-amis',
  templateUrl: './modal-inviter-amis.component.html',
  styleUrls: ['./modal-inviter-amis.component.css']
})
export class ModalInviterAmisComponent implements OnInit {
